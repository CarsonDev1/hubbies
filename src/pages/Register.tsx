...
// 		setIsLoading(true);
// 		try {
// 			const response = await fetch('https://hubbies-be.azurewebsites.net/api/auths/event-host/register', {
// 				method: 'POST',
// 				headers: {
...
// 			style={{
// 				backgroundImage:
// 					"url('https://images.unsplash.com/photo-1585241936939-be4099591252?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')",
// 			}}
// 		>
...
// 					<p className='text-gray-600'>Sign up to get started and enjoy our services</p>
// 				</div>
